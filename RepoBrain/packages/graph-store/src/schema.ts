// AUTO-DERIVED from src/migrations/001_init.sql — keep byte-identical to that file.
// The .sql file is the source of truth; this inlined copy avoids runtime path
// problems (tsc does not copy .sql into dist). If you change 001_init.sql,
// regenerate this constant so the two stay in sync.

export const SCHEMA_SQL = `-- RepoBrain graph store — migration 001 (init).
